...
/// <summary>
/// Generic collection class for storing and iterating objects of type T.
/// </summary>
/// <typeparam name="T">The type of objects to store in the collection.</typeparam>
public class Objs<T> : IEnumerable<T>
{
    /// <summary>
    /// List to hold the collection of objects.
    /// </summary>
    ...
    /// <summary>
    /// Returns a generic enumerator to iterate through the collection.
    /// </summary>
    ...
    /// <summary>
    /// Returns a non-generic enumerator to iterate through the collection.
    /// </summary>
    /// <returns>An enumerator for the collection.</returns>
