...
/// <summary>
/// Class to handle actions on room objects
/// </summary>
public class RoomObjects
{
    /// <summary>
    /// Iterates through room objects and performs actions based on the provided type
    /// </summary>
    /// <param name="roomObjects">List of objects to iterate throught</param>
